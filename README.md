...
| `<xstd/concepts/exposition_only/integral-class.hpp>` | `integral_class_type` <br> `is_integral_like` | Structural form of an integer-class type <br> Structural form of `is-integer-like`, over the above | [iterator.concept.winc] <br> [iterator.concept.winc] |
