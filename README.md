...
| `<type_traits>` | `is_any_of<T, Args...>` <br> `to_underlying_type` |  `disjunction<is_same<T, Args>...>` <br> Converts an enum to its underlying type | <br> [Effective Modern C++](http://shop.oreilly.com/product/0636920033707.do), Item 10 | 
