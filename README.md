...
| :----- | :-------- | :---------- | :-------- |
| `<xstd/concepts.hpp>` | `integer_like` <br> `signed_integer_like` <br> `unsigned_integer_like` <br> `has_unsigned_counterpart` <br> `nothrow_integer_operators` <br> `specialization_of` | Constraint form of `is_integer_like` <br> Open form of `std::signed_integral` <br> Open form of `std::unsigned_integral` <br> Domain of the integer functions <br> Exception specification of the integer functions <br> Constraint form of `is_specialization_of` | [iterator.concept.winc] (integer-class types) <br> [iterator.concept.winc] (integer-class types) <br> [iterator.concept.winc] (integer-class types) <br> none <br> none <br> [p2098r1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p2098r1.pdf) (not adopted) |
