...
| `<type_traits>` |  `to_utype` <br> `any_of<T, Xs...>` <br> `or_empty<B, T>` | Converts an enum to its underlying type <br> `(is_same_v<T, Xs> or ...)` <br> `conditional_t<B, T, empty<T>>` | [Effective Modern C++](http://shop.oreilly.com/product/0636920033707.do), Item 10 <br> none  <br> none |
