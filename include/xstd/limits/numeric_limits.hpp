...
template<class T, bool = std::is_object_v<T> and not std::is_array_v<T>>
struct numeric_limits_base
{};

template<class T>
struct numeric_limits_base<T, true> : std::numeric_limits<T>
{};
...
template<class T>
struct numeric_limits : detail::numeric_limits_base<T>
{};
