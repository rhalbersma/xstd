...
#ifndef XSTD_INTS_TYPE_TRAITS_IS_UNSIGNED_HPP
#define XSTD_INTS_TYPE_TRAITS_IS_UNSIGNED_HPP
...
inline constexpr auto is_unsigned_v<I_cv> = [] -> bool {
...
#endif // XSTD_INTS_TYPE_TRAITS_IS_UNSIGNED_HPP
