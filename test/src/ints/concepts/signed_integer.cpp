...
BOOST_AUTO_TEST_CASE_TEMPLATE(AdmitsTheExactWidthTypesThroughCv, T, test::exact_width_signed_integer_types)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(UnsignedIsNotSigned, T, test::exact_width_unsigned_integer_types)
{
