...
BOOST_AUTO_TEST_CASE_TEMPLATE(TheTraitsAndTheModifiersAgree, T, test::exact_width_signed_integer_types)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(TheTraitsAndTheModifiersAgreeUnsigned, T, test::exact_width_unsigned_integer_types)
{
        static_assert(consistent<T>);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(PromotionKeepsASignedTypeSigned, T, test::exact_width_signed_integer_types)
{
