...
{
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{+8}, T{+3})), (xstd::div_t<T>{+2, +2}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{+8}, T{-3})), (xstd::div_t<T>{-3, -1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{-8}, T{+3})), (xstd::div_t<T>{-3, +1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{-8}, T{-3})), (xstd::div_t<T>{+2, -2}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{+1}, T{+2})), (xstd::div_t<T>{0, +1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{+1}, T{-2})), (xstd::div_t<T>{-1, -1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{-1}, T{+2})), (xstd::div_t<T>{-1, +1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{-1}, T{-2})), (xstd::div_t<T>{0, -1}));
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(FlooredDivUnsigned, T, xstd::test::exact_width_unsigned_integer_types)
{
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{8}, T{3})), (xstd::div_t<T>{2, 2}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{1}, T{2})), (xstd::div_t<T>{0, 1}));
        XSTD_CONSTEXPR_CHECK_EQUAL_IF(xstd::test::has_constexpr_division<T>, (xstd::floored_div(T{0}, T{3})), (xstd::div_t<T>{0, 0}));
}
