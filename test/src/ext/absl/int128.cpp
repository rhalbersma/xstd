...
BOOST_AUTO_TEST_CASE(AssociationsPairTheTwoHalves)
{
        ...
        using S = xstd::test::absl_int128;
        using U = xstd::test::absl_uint128;
...
{
#ifdef XSTD_TEST_HAS_ABSL_INT128
        XSTD_CONSTEXPR_CHECK(xstd::signed_integer<xstd::test::absl_int128>);
        XSTD_CONSTEXPR_CHECK(xstd::unsigned_integer<xstd::test::absl_uint128>);
#endif
        BOOST_CHECK(true);
}
